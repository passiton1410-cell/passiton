  ...
  return (
    <footer className="w-full bg-[#f8f4f0] text-[#3a2f45] px-6 py-12 font-[Inter,sans-serif]">
      <div className="max-w-6xl mx-auto">
        {/* First row: Logo and About + Marketplace & Quick Links side by side on mobile */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 sm:place-items-center md:place-items-start">
          {/* Logo and About */}
          <div className="flex flex-col items-center sm:items-center md:items-start text-center sm:text-center md:text-left">
            <Image src="/startup_india.png" alt="PassitOn Logo" width={180} height={60} />
          ...
          {/* Marketplace & Quick Links Container for Mobile */}
          <div className="col-span-1 sm:col-span-1 md:col-span-2 grid grid-cols-2 gap-6 md:gap-10">
            {/* Marketplace */}
          ...
          {/* Contact Icons - Hidden on mobile, shown on md+ */}
          <div className="hidden md:block text-center sm:text-center md:text-left">
        ...
        {/* Contact section for mobile - full width */}
        <div className="block md:hidden mt-10">
          <div className="text-center">
            <h3 className="text-lg font-semibold mb-4 text-[#7e5a9b] tracking-wide">Contact</h3>
            <div className="flex justify-center space-x-5 text-[#7e5a9b]">
              <a href="https://www.linkedin.com/company/pass-it-on-–-pass-karo-earn-karo/" target="_blank" rel="noopener noreferrer">
                <Linkedin className="w-5 h-5 hover:text-[#aa7bb8] transition-colors" />
              </a>
              <a href="mailto:hi@passiton.cash" target="_blank" rel="noopener noreferrer">
