...
export const INDIAN_STATES_CITIES: StateData[] = [
  {
    name: "Andhra Pradesh",
    cities: [
      "Amaravati", "Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna",
  ...
  },
  {
    ...
    cities: [
      "Anjaw", "Changlang", "East Kameng", "East Siang", "Itanagar", "Kamle",
      ...
      "Shi Yomi", "Tawang", "Tirap", "Upper Dibang Valley", "Upper Siang", "Upper Subansiri", "West Kameng", "West Siang"
    ]
  },
  {
    name: "Assam",
  ...
  },
  {
    name: "Goa",
    cities: [
      "North Goa", "Panaji", "South Goa", "Vasco da Gama"
    ]
  },
  {
    name: "Gujarat",
  ...
  },
  {
    ...
    cities: [
      ...
      "Maihar", "Mandla", "Mandsaur", "Morena", "Narsinghpur", "Neemuch", "Niwari",
  ...
  },
  {
    name: "Tripura",
    cities: [
      "Agartala", "Dhalai", "Gomati", "Khowai", "North Tripura", "Sepahijala",
  ...
  // Union Territories
  {
    ...
    cities: [
      "Nicobar", "North and Middle Andaman", "Port Blair", "South Andaman"
    ]
  },
  {
    name: "Chandigarh",
  ...
  },
  {
    name: "Lakshadweep",
    cities: [
      "Agatti", "Amini", "Andrott", "Bithra", "Chetlat", "Kadmat", "Kalpeni",
...
export const getStates = (): string[] => {
  return INDIAN_STATES_CITIES.map(state => state.name).sort();
};

// Get cities for a specific state in alphabetical order
export const getCitiesForState = (stateName: string): string[] => {
  const state = INDIAN_STATES_CITIES.find(s => s.name === stateName);
  return state ? state.cities.sort() : [];
};

// Get all cities across all states in alphabetical order
export const getAllCities = (): string[] => {
  const allCities = INDIAN_STATES_CITIES.flatMap(state => state.cities);
